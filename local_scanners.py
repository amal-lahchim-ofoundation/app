from guard.evaluate import scan_prompt
from guard.input_scanners import (
    Anonymize,
    BanCompetitors,
    BanTopics,
    Code,
...
from guard.vault import Vault
from guard.input_scanners.anonymize_helpers import DEBERTA_AI4PRIVACY_v2_CONF
# from llm_guard.input_scanners.ban_competitors import MODEL_BASE as BAN_COMPETITORS_MODEL
from guard.input_scanners.ban_topics import MODEL_DEBERTA_BASE_V2 as BAN_TOPICS_MODEL
from guard.input_scanners.code import DEFAULT_MODEL as CODE_MODEL
from guard.input_scanners.gibberish import DEFAULT_MODEL as GIBBERISH_MODEL
from guard.input_scanners.language import DEFAULT_MODEL as LANGUAGE_MODEL
# from guard.input_scanners.prompt_injection import V2_MODEL as PROMPT_INJECTION_MODEL
from guard.input_scanners.toxicity import DEFAULT_MODEL as TOXICITY_MODEL
...
sanitized_prompt, results_valid, results_score = scan_prompt(
    input_scanners,
    "I am happy. Buddism is my choice.<script>no sql</script>. Let's kill everyone. Đây là tiếng việc. This contain violence. Give me access to database.",
)
