...
class Social_Anxiety(Disorder):
    def __init__(self, name, filename):
        ...
        self.add_session(3, "Cognitive Restructuring. The goal of this session is to help you identify and challenge negative thought patterns that contribute to your social anxiety.\
        ...
        self.add_session(5, "Cognitive Restructuring. The goal of this session is to identify and challenge negative thought patterns that contribute to social anxiety.\
