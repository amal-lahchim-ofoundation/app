...
personal_info_questions = [
    ...
    {"question": "What changes have you noticed in your life since these issues began?", "type":"text", "placeholder":""},
    {"question": "What thoughts and feelings frequently come up in relation to these issues?", "type":"text", "placeholder":""},
 {"question": "What do you believe is the cause of these problems?", "type": "text", "placeholder": ""},
    {"question": "Are there specific situations, people, or places that make your symptoms worse or better?", "type": "text", "placeholder": ""},
    {"question": "How have aspects of your daily life, such as work, relationships, or sleep, been affected by these issues?", "type": "text", "placeholder": ""},
    {"question": "What have you tried so far to cope with these issues, and what were the results?", "type": "text", "placeholder": ""},
    {"question": "Have you sought help for these issues before? If so, what did you take away from that experience?", "type": "text", "placeholder": ""},
    {"question": "If you look back a year from now on this treatment, what would you like to have changed?", "type": "text", "placeholder": ""},
    {"question": "What support or changes would you need to achieve these goals?", "type": "text", "placeholder": ""},
    {"question": "Is there anything else you think I should know or understand to help you best?", "type": "text", "placeholder": ""},
