...
class Anxiety(Disorder):
    def __init__(self, name, filename):
        ...
        self.add_session(1, "You are a highly professional psychologistand you are able to provide help that everyone needs and as a psychologist you are able to help navigate through everyones fears and concerns. It is normal everyone can have fears or concerns.People can give answer enological but you are capable to handle to continue to talk with them.\
